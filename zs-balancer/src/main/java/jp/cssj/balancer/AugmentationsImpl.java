 ...
 * augmentations interface contained a <code>clear()</code> method to remove all
 * of the items from the augmentations instance. A later version of XNI changed
 * this method to <code>removeAllItems()</code>. Therefore, this class extends
 * the augmentations interface and explicitly implements both of these methods.
 * <p>
 * <strong>Note:</strong> This code is inspired by performance enhancements
 * submitted by Marc-Andr� Morissette.
 * 
 * @author Andy Clark
 */
