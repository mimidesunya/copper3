...
cti-driver-2.2.2.jar	-- ドライバ本体（CTIP, REST, CLIが利用可能）
cti-driver-min-2.2.2.jar	-- 最小構成のドライバ（REST, CLIは利用不可）
...
Linux
java -cp cti-driver-2.2.2.jar:classes クラス名
