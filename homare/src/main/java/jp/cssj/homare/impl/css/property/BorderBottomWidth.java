 ...
 * @version $Id: BorderBottomWidth.java 1552 2018-04-26 01:43:24Z miyabe $
 */
public class BorderBottomWidth extends AbstractPrimitivePropertyInfo {
	public static final PrimitivePropertyInfo INFO = new BorderBottomWidth();
