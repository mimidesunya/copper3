 ...
 * @version $Id: MarginBottom.java 1552 2018-04-26 01:43:24Z miyabe $
 */
public class MarginBottom extends AbstractPrimitivePropertyInfo {
	public static final PrimitivePropertyInfo INFO = new MarginBottom();
