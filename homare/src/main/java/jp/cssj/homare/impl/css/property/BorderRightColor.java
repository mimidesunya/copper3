 ...
 * @version $Id: BorderRightColor.java 1624 2022-05-02 08:59:55Z miyabe $
 */
public class BorderRightColor extends AbstractPrimitivePropertyInfo {
	public static final PrimitivePropertyInfo INFO = new BorderRightColor();
