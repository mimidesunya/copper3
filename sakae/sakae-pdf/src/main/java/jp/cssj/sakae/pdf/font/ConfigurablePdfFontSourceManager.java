...
import jp.cssj.sakae.font.emoji.EmojiFontSource;
...
public class ConfigurablePdfFontSourceManager extends PdfFontSourceManager {
	...
	protected synchronized void poll() {
		...
		try {
			...
			FontLoader.add(EmojiFontSource.INSTANCES_LTR, handler.nameToFonts);
			FontLoader.add(EmojiFontSource.INSTANCES_TB, handler.nameToFonts);
