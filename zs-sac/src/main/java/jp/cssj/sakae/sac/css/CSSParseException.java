...
public class CSSParseException extends CSSException {
	 ...
	 * <p>
	 * This constructor is especially useful when an application is creating its own
	 * exception from within a DocumentHandler callback, and needs to wrap an
	 ...
	 * @param lineNumber
	 *            The line number of the end of the text that caused the error or
	 *            warning.
	 * @param columnNumber
	 *            The column number of the end of the text that cause the error or
	 *            warning.
	 * @see Parser#setLocale
	 */
