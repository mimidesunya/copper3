...
public interface ConditionFactory {
	 ...
	 * @param type
	 *            <code>true</code> true if the list should contain only nodes of
	 *            the same node (for element, same localName and same namespaceURI).
	 ...
	 *                if this exception is not supported.
	 */
	AttributeCondition createOneOfAttributeCondition(String localName, String namespaceURI, boolean specified,
	 ...
	 *                if this exception is not supported.
	 */
	AttributeCondition createBeginHyphenAttributeCondition(String localName, String namespaceURI, boolean specified,
			String value) throws CSSException;
