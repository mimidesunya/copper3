...
public interface ErrorHandler {
	 ...
	 *
	 * <p>
	 * CSS parsers will use this method to report conditions that are not errors or
	 * fatal errors as defined by the XML 1.0 recommendation. The default behaviour
	 * is to take no action.
	 * </p>
	 *
	 * <p>
	 * The CSS parser must continue to provide normal parsing events after invoking
	 ...
	 * should report a fatal error even if the XML 1.0 recommendation does not
	 * require it to do so.
	 * </p>
	 *
	 * @param exception
	 ...
	 * collecting addition error messages: in fact, CSS parsers are free to stop
