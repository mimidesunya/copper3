...
public interface AttributeCondition extends Condition {
	...
	/**
	 * Returns <code>true</code> if the attribute must have an explicit value in the
	 * original document, <code>false</code> otherwise.
	 */
	public boolean getSpecified();

	/**
	 * Returns the value of the attribute. If this attribute is a class or a pseudo
	 * class attribute, you'll get the class name (or psedo class name) without the
	 * '.' or ':'.
	 */
