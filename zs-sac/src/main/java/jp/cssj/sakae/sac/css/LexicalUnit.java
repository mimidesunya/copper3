 ...
 * <p>
 * <b>Remarks</b>: Not all the following lexical units are supported (or will be
 * supported) by CSS.
 * <p>
...
public interface LexicalUnit {
	 ...
	 * <p>
	 * If the type of <code>LexicalUnit</code> is one of SAC_DEGREE, SAC_GRADIAN,
	 * SAC_RADIAN, SAC_MILLISECOND, SAC_SECOND, SAC_HERTZ or SAC_KILOHERTZ, the
