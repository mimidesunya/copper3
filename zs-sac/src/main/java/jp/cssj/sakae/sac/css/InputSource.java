...
import jp.cssj.sakae.sac.css.Locator;
...
public class InputSource {
	 ...
	 *
	 * <p>
	 * Application writers may use setURI() to provide a base for resolving relative
	 ...
	 *
	 * <p>
	 * The URI is optional if there is a byte stream or a character stream, but it
	 * is still useful to provide one, since the application can use it to resolve
	 * relative URIs and can include it in error messages and warnings (the parser
	 * will attempt to open a connection to the URI only if there is no byte stream
	 * or character stream specified).
	 * </p>
	 *
	 * <p>
	 * If the application knows the character encoding of the object pointed to by
	 * the URI, it can register the encoding using the setEncoding method.
	 * </p>
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * The encoding must be a string acceptable for an CHARSET encoding declaration
	 * (see section 4.4 of the CSS recommendation Level 2).
	 * </p>
	 *
	 * <p>
	 ...
	 * stream and will not attempt to open a URI connection to the URI.
	 * </p>
	 *
	 * @param characterStream
	 *            The character stream containing the CSS document or other entity.
	 ...
	 *            <a href=
	 *            "http://www.w3.org/TR/REC-html40/struct/links.html#edef-LINK">LINK</A>
